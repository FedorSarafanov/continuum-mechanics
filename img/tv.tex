...
\filldraw[myblue] (0,0) rectangle (3,1);
\filldraw[myblue!50!black] (0,1) -- (3,1);

\draw[draw=none, pattern=north east lines] (0,0) rectangle (3,-0.15);

\draw[->,semithick] (1,0.33) -- ++(1,0);
\draw[->,semithick] (1,0.66) -- ++(1,0);
