...
% \draw[rotate around={-30:(0.3,0)}, xshift=0.3cm, densely dashed] (0,0) arc [ start angle=0,   
%                               end angle=360,
%                               x radius=0.25, 
%                               y radius=0.5]
%         coordinate [pos=0.06,sloped] (1a) {}  
...
\draw[] (0,-0.1) to [out=0,in=180,looseness=1] ++ (1,-0.5) to [out=0,in=180,looseness=1] ++ (1,0.5);
\draw[] (0,0.1) to [out=0,in=180,looseness=1] ++ (1,0.5) to [out=0,in=180,looseness=1] ++ (1,-0.5);

% to [out=0,in=180,looseness=1] ++ (1,-0.5);
% \draw[yscale=-1] (0,0.05) to [out=0,in=180,looseness=1] ++ (1,0.5) to [out=0,in=180,looseness=1] ++ (1,-0.5);

\draw[fill=black!20] (1,0) circle (0.4);

\draw[fill=myblue, opacity=0.5, dashed] (1.5,0) circle (0.2);
\draw[opacity=0.5] (1.5,0) ++ (45:0.2) -- ++(45:0.5) to [out=45, in=180] ++ (0.25,0.15) node[right, opacity=1, black] {Застойная зона};
\draw[opacity=0, xscale=-1] (-0.5,0) ++ (45:0.2) -- ++(45:0.5) to [out=45, in=180] ++ (0.25,0.15) node[left, opacity=0, black] {Застойная зона};

\draw[] (0,0.05) -- ++(0.4,0) to [out=0,in=-110,looseness=1] ($(1,0)+(160:0.5)$) ($(1,0)+({-cos(20)*0.5},{sin(20)*0.5})$) arc [ start angle=160,   
                              end angle=20,
                              x radius=0.5, 
                              y radius=0.5] to [out=-70,in=180,looseness=1] (2-0.4,0.05) -- (2,0.05);

\draw[yscale=-1] (0,0.05) -- ++(0.4,0) to [out=0,in=-110,looseness=1] ($(1,0)+(160:0.5)$) ($(1,0)+({-cos(20)*0.5},{sin(20)*0.5})$) arc [ start angle=160,   
                              end angle=20,
                              x radius=0.5, 
                              y radius=0.5] to [out=-70,in=180,looseness=1] (2-0.4,0.05) -- (2,0.05);
