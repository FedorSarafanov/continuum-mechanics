...
\draw (0,0) to [out=60, in=180] (2,1) to[out=0, in=90] ++(1,-1) to[out=-90, in=0] ++ (-2,-1) to [out=180, in=-120] (0,0)  node[pos=0.5,left] {$S'$};


\draw[scale=0.5, xshift=1.5cm,thick] (0,0) to [out=60, in=180] (2,1) to[out=0, in=90] ++(1,-1) to[out=-90, in=0] ++ (-2,-1) to [out=180, in=-120] (0,0) node[pos=0.5,right,scale=2] {$S$};
