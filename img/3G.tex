...
\begin{tikzpicture}[
    ...
    \draw (180:1) circle (0.2);
    \draw (0:1) circle (0.2);
    \draw[->] (180:1) ++(180:0.2) -- ($(180:1)+(170:0.2)$);
    \draw[->] (0:1) ++(0:0.2) -- ($(0:1)+(10:0.2)$);
    ...
    % \draw[->] (20:1) -- (22:1);
    % \draw[->] (200:1) -- (202:1);
    \draw[fill=black] (0:1)  circle (0.05) node[right=0.5em] {$\Gamma$};
    \draw[fill=black] (180:1)  circle (0.05) node[left=0.5em] {$-\Gamma$};
