...
% \draw (2,5)--(2,-1);
\draw[fill = myblue, draw = none,scale=1,name path =B, domain=0:3,smooth,variable=\x] plot ({\x},{sin(deg(2*pi*\x/2))/5+1.5}) -- (3,0) -- (0,0) -- cycle;
...
\lineann[0.5]{0}{2}{$l$}
\end{scope}
\begin{scope}[yshift=(1.3cm),xshift=2.5cm]
\lineann[-1]{90}{2/5}{$A$}
\end{scope}
