...
\draw[dashed] (0,0) ellipse (0.5 and 0.25) node[right=2.2em] {$S_1$};

\draw[dashed] (2,-2) ellipse (0.25 and 0.5) node[above=2.2em] {$S_2$};

\draw[tangent=0.5] (-0.5,0) to[out=-90, in=180] (2,-2.5);
\draw (0.5,0) to[out=-90, in=180] (2,-1.5);

\draw[blue,latex-] (0,0) -- ++ (0,0.5) node[above] {$v_1$};
\draw[blue,-latex] (2,-2) -- ++ (0.5,0) node[above] {$v_2$};


\draw [blue, use tangent,-latex] (0,0) -- ++ (-90:1) node[below] {$\vec{F}$};
\draw [fill=blue,use tangent] (0,0) circle (1pt);
